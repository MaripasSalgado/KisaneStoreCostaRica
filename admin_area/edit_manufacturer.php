...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['edit_manufacturer'])) {
        ...
        $stmt_get_manufacturer = $pdo->prepare($get_manufacturer);
        $stmt_get_manufacturer->execute([$edit_manufacturer]);
        $row_manufacturer = $stmt_get_manufacturer->fetch(PDO::FETCH_ASSOC);
...
<?php
    if (isset($_POST['update'])) {
        ...
        $update_manufacturer = "CALL UpdateManufacturer(?, ?, ?, ?)";
        $stmt_update_manufacturer = $pdo->prepare($update_manufacturer);
        $stmt_update_manufacturer->execute([$manufacturer_name, $manufacturer_top, $manufacturer_image, $m_id]);
        if ($stmt_update_manufacturer) {
